...
public class RealEstateAdminActiveAgentsPage {
    ...
    public static WebElement activeAgentDeleteDropdownLocator(String activeAgentDdeleteDropdown) {
        return WebDriverUtils.driver.findElement(By.xpath("//td[normalize-space()='" + activeAgentDdeleteDropdown
    ...
    public static WebElement activeAgentDeleteLocator(String activeAgentDeleteButton) {
        return WebDriverUtils.driver.findElement(By.xpath("//td[normalize-space()='" + activeAgentDeleteButton
                + "']//parent::td//parent::tr//child::td[4]//child::div//child::ul//child::li//child::button"));
    }
